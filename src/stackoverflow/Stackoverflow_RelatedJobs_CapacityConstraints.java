 ...
 *
 */
public class Stackoverflow_RelatedJobs_CapacityConstraints {
...
//			
			...
			new Plotter(vrp,Solutions.bestOf(solutions)).setLabel(Label.ID).plot("output/jsprit_vrpnc1_capConstraints", "jsprit: capacityConstraints");
	}
